...
export default class UIManager {
  ...
  initUIElements() {
    ...
    this.tournamentSelectField = document.getElementById(
    ...
    this.confirmAddPlayerButton = document.getElementById(
      'confirmAddPlayerButton'
    );
    this.cancelAddPlayerButton = document.getElementById(
      'cancelAddPlayerButton'
    );
    ...
    this.cancelRemovePlayerButton = document.getElementById(
      'cancelRemovePlayerButton'
    );

    // Tournament Players Dialog elements
    this.tournamentPlayersButton = document.getElementById(
      'tournamentPlayersButton'
    );
    this.tournamentPlayersDialog = document.getElementById(
      'tournamentPlayersDialog'
    );
    this.tournamentPlayersList = document.getElementById(
      'tournamentPlayersList'
    );
    this.cancelTournamentPlayersButton = document.getElementById(
      'cancelTournamentPlayersButton'
    );
    this.saveTournamentPlayersButton = document.getElementById(
      'saveTournamentPlayersButton'
    );

    // Create Tournament Dialog elements
    this.createNewTournamentButton = document.getElementById(
      'createNewTournamentButton'
    );
    // Assuming you have a dialog element for creating tournaments
    this.createTournamentDialog = document.getElementById(
      'createTournamentDialog'
    );
    this.tournamentNameField = document.getElementById('tournamentNameField');
    this.confirmCreateTournamentButton = document.getElementById(
      'confirmCreateTournamentButton'
    );
    this.cancelCreateTournamentButton = document.getElementById(
      'cancelCreateTournamentButton'
    );
  ...
  bindEventListeners() {
    ...
    this.confirmAddPlayerButton.addEventListener('click', () =>
      this.handleAddPlayer()
    );
    this.cancelAddPlayerButton.addEventListener('click', () =>
      this.closeAddPlayerDialog()
    );

    // Remove Player Dialog
    this.removePlayerButton.addEventListener('click', () =>
      this.openRemovePlayerDialog()
    );
    this.cancelRemovePlayerButton.addEventListener('click', () =>
      this.closeRemovePlayerDialog()
    );
    ...
    this.tournamentPlayersButton.addEventListener('click', () =>
      this.openTournamentPlayersDialog()
    );
    this.cancelTournamentPlayersButton.addEventListener('click', () =>
      this.closeTournamentPlayersDialog()
    );
    this.saveTournamentPlayersButton.addEventListener('click', () =>
      this.saveTournamentPlayers()
    );

    // Create Tournament Dialog
    this.createNewTournamentButton.addEventListener('click', () =>
      this.openCreateTournamentDialog()
    );
    this.confirmCreateTournamentButton.addEventListener('click', () =>
  ...
  populateTournamentPlayersList() {
    ...
    allPlayers.forEach((player) => {
      ...
      const tournamentPlayerIdsNumeric = tournamentPlayerIds.map((id) =>
        Number(id)
      );

      // Set the switch state
      participationSwitch.selected = tournamentPlayerIdsNumeric.includes(
        playerId
      );
  ...
  async saveTournamentPlayers() {
    ...
    try {
      ...
      await this.tournamentManager.updateTournamentPlayers(
